...
class MinDurationSessionTest {
    ...
    void shouldReturnMinDurationInMinutes() {
        var sessions = List.of(
                ...
                new SleepingSession(dt("14:00"), dt("14:30"), SleepQuality.BAD),
                new SleepingSession(dt("16:00"), dt("16:15"), SleepQuality.NORMAL)
        );
        assertEquals("15", function.apply(sessions));
    }
